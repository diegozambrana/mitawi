...
export const OrganizationHelp = () => {
  return (
    <Box>
      ...
      <Text mb="1rem">
        To add a new organization, simply click on the{" "}
        <Badge color="nord10">+ Add New</Badge> button and provide the full name
        of the organization in the following format:
      ...
      <Text mb="1rem" fw={700}>
        Obtaining data about organizations takes time, so it may occasionally
        fail. We are actively working on enhancing this process to improve the
        user experience.
      </Text>
